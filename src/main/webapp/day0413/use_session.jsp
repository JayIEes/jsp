...
<tr>
	...
	<%if(!sessionLike){%>
	<a href="use_session.jsp?flag=like" id="like" >👍</a>
	<%}else {%>
	<strong>좋아요를 선택하였습니다.</strong>
	<% }%>
	<!-- 좋아요는 이 브라우저가 실행되어 있는 동안 한번만 클릭할 수 있다. 한번 클릭한 이후에는 다른 페이지에 갔다가 오더라도 
		이미지를 숨긴다. 이미지 대신 "좋아요를 누르셨습니다."-->
	</td>
</tr>
</table>
